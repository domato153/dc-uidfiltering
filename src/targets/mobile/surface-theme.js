; (() => {
    ...
    const CSS = `
        ...
        html[data-dcuf-palette] body .gall_listwrap:has(.custom-mobile-list) { padding:0!important; }
        ...
        @media (max-width:760px) {
            ...
            html[data-dcuf-palette] body:not(.is-write-page) .list_array_option { grid-template-columns:minmax(0,1fr) auto!important; }
